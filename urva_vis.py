...
if current_mode == "Dark":
    print("Error: Dark mode has been detected on your machine. To improve the visibility of the URVAvis GUI widgets, please use light mode instead.")
    sys.exit()

# Print URVAvis initialization statement
if os.path.exists('./frames') == False:
    print("Initializing URVAvis version 0.1.0 \nGeneration and processing of animation frames may take a few minutes (one-time process). Please wait ... \n")
else:
    print("Initializing URVAvis version 0.1.0 \nPlease wait ... \n")
...
class MyFrame(wx.Frame):    
    def __init__(self):
        ...
        super().__init__(parent=None, title='URVAvis',size=(1100,750))
