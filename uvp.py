...
if os.path.exists('./frames') == False:
    print("Initializing UVP. Generation and processing of animation frames may take a few minutes (one-time process). Please wait ... \n")
else:
    print("Initializing UVP. Please wait ... \n")
