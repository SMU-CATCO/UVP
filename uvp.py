#    URVA Visualization Program (UVP), version 1.0.0 (3.11.26)
...
if os.path.exists('./frames') == False:
    print("Initializing UVP version 1.0.0. Generation and processing of animation frames may take a few minutes (one-time process). Please wait ... \n")
else:
    print("Initializing UVP version 1.0.0. Please wait ... \n")
